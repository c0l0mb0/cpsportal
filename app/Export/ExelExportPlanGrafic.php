...
class ExelExportPlanGrafic extends ExcelExport
{
    ...
    public function createHead()
    {
        ...
        $this->excelRowCursor++;
        $this->insertJustTextDataInRow($this->excelRowCursor, $this->excelColumnCursor, array('_________________В.А. Медун'), null, $styleArray);
    ...
    {
//        $plan_graf_book = 'ГП-2';
//        $plan_graf_worksheet = 'ДКС-2 ГПА';
        $plan_graf_book = 'Ямбург';
        $plan_graf_worksheet = 'НФЖК';
        $this->planGrafBuildings = BuildingsController::getBuildings([['plan_graf_book', '=', $plan_graf_book],
            ['plan_graf_worksheet', '=', $plan_graf_worksheet]]);

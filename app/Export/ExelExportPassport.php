...
class ExelExportPassport extends ExcelExport
{
    ...
    public function createBody()
    {
        ...
        $this->sheet->getStyle('A8:G8')
            ->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);
        $this->buildingsWithEquipment = BuildEquipController::getBuildingWithEquipmentByBuildingId([['buildings.id', '=', $currentBuldingId]]);
...
//        =================================================================================================================
        ...
        $this->buildingsWithEquipment = BuildEquipController::getBuildingChannelsByBuildingId([['buildings.id', '=', $currentBuldingId]]);

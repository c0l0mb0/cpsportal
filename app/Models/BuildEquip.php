...
class BuildEquip extends Model
{
    ...
    protected $fillable = [
        'id_build', 'id_equip', 'quantity', 'measure', 'cel_january_gray', 'cel_february_gray', 'cel_march_gray',
        ...
        'cel_october_gray', 'cel_november_gray', 'cel_december_gray', 'numb_syst_asps', 'numb_syst_aspt', 'equip_year',
         'cel_july', 'cel_november', 'cel_january', 'cel_august', 'cel_february', 'who_change', 'cel_march',
        'cel_september', 'cel_april', 'cel_december', 'cel_may', 'cel_october', 'cel_june', 'who_create',
        'equip_comments', 'deleted_by_worker', 'edited_by_worker', 'created_by_worker'
    ];
}
